    ...
    return (
      <div>
        ...
        <main className="event-not-found">
          ...
          <p>
            The event you're looking for doesn't exist. It may have been renamed
            or removed.
          </p>
          ...
          <Section title="Registration Form">
            {ev.registrationForm.required?.length ? (
              <p>
                ...
                {ev.registrationForm.required.join(", ")}
              </p>
            ) : null}
            {ev.registrationForm.optional?.length ? (
              <p>
                <strong>Optional:</strong>{" "}
                {ev.registrationForm.optional.join(", ")}
              </p>
            ) : null}
            {ev.registrationForm.additional?.length ? (
              <ul>
                {ev.registrationForm.additional.map((a, i) => (
                  <li key={`add-${i}`}>{a}</li>
                ))}
              </ul>
            ) : null}
