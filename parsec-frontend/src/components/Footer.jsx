  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        {/* Section 1: Logos and Contact Info */}
        <div className="footer-section footer-brand">
          ...
          <div className="footer-contact">
            <p className="footer-text">IIT Dharwad - Permanent Campus, Karnataka</p>
            <p className="footer-text">PIN - 580011</p>
            {/* Email to be provided */}
            <p className="footer-text footer-email">
              <a href="mailto:gstech@iitdh.ac.in">gstech@iitdh.ac.in</a><br />
              <span className='footer-text'>General Secretary Technical Affairs</span>
            </p>
          </div>
        </div>
        ...
        <div className="footer-section footer-support">
          ...
          <ul className="footer-nav">
            <li><a href="#sponsor">Sponsor Parsec 6.0</a></li>
          </ul>
        </div>

        {/* Section 4: Social and Copyright */}
